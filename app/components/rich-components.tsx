  ...
  return (
    <div className="p-3 mt-10 border border-gray-200 rounded">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-8 gap-4">
        {richdata.map((i) => (
          <div
            className="flex cursor-pointer hover:scale-105  items-center justify-center text-2xl font-bold border rounded-lg shadow-md aspect-square hover:shadow-lg transition-all duration-300"
            key={i}
          >
            {i}
          </div>
